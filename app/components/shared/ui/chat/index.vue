    ...
    <div class="flex h-full min-h-0 flex-col bg-background text-foreground">
        <header class="flex shrink-0 items-center gap-2 border-b border-border px-3 py-2">
            ...
            <button
                v-if="titleClickable"
                type="button"
                class="flex min-w-0 flex-1 flex-col text-center"
        ...
        <footer
            v-if="showComposer"
            class="flex shrink-0 items-center gap-2 border-t border-border px-3 py-2 pb-[calc(env(safe-area-inset-bottom)+0.5rem)]"
        >
            <slot name="composer">
                <Button
                    variant="ghost"
